...
namespace ECatalogRecommendations
{
    ...
    {   
        ...
        private List<KeyValuePair<SearchRequest, double>> _result = new List<KeyValuePair<SearchRequest, double>>(); 
        ...
        public void AnalyzeAction(FrontOfficeAction action)
        {
            ...
            if (code != null && Enum.IsDefined(typeof(Transition), code))
            {
                ...
                {
                    _currentSearchRequest = new SearchRequest(action.ActionComment);
        ...
        public List<KeyValuePair<SearchRequest, double>> GetResult()
        {
            return _result;
        }
        ...
        private void FinishSequenceAnalyze()
        {
            ...
            {
                _result.Add(new KeyValuePair<SearchRequest, double>(_lastSearchRequest, _usefullness));
            }
            StartAgain();
        }
